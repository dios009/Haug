...
int main() {
	...
	FILE *fptr;
	fptr = fopen("datos-k100-angular.dat","w");
...
for (j= 1; j<DIV; j++){
double count = 0.;
x2+=1./DIV; //para evitar los valores del borde. Hay problema para evaluar MM en E2=emax y emin
for (i = 1; i < NEVAL+1 ; ++i)
  {
